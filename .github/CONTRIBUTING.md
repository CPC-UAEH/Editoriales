...
Gracias por ayudar a mejorar las editoriales del Club de Programación Competitiva
de la UAEH. Este repositorio recibe editoriales, correcciones y propuestas de la
comunidad. Lee también el [Código de Conducta](./CODE_OF_CONDUCT.md).

## Qué puedes aportar

- Correcciones de ortografía, redacción, enlaces o errores técnicos.
- Nuevas editoriales de problemas con razonamiento, correctitud y complejidad.
...
1. Busca [issues y Pull Requests abiertos](https://github.com/CPC-UAEH/Editoriales/issues) para evitar duplicar trabajo.
...
4. Sigue la estructura de `template/periodo-academico/evento/concurso/`.
...
5. Sigue la estructura de `template/periodo-academico/evento/concurso/`.
...
| `feat:`    | Nueva editorial o contenido                               |
